...
/**
 * Data source for the Periodict view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class PeriodictDataSource extends DataSource<UserData> {
  data: UserData[];

  constructor(private paginator: MatPaginator, private sort: MatSort, private dataService: DataService) {
    super();

    this.dataService.getUsers().subscribe(dados => this.data = dados);
